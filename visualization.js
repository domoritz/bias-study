	...
	if (label == 'approximate') {
		...
		if(studyCondition == 'onlyNew') {
			...
			if(studyCondition == 'difference') {
				...
				$('#visualization').prepend("<div class='col-xs-6'><img src='data/images/" + visualizationLookingAt + "_1_0.png' width='430px'></div><div class='col-xs-6'><img src='data/images/" + visualizationLookingAt + "_" + amountError + "_" + sequenceNumber + ".png' width='430px'></div>");
				$('#visualization').prepend("<div class='col-xs-6'><h2>Approximate</h2></div><div class='col-xs-6'><h2>Precise</h2></div>")
			}
		}
	}
});
