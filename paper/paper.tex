...
We recruited participants from Amazon Mechanical Turk (AMT), a common tool to run perception studies for visualizations~\cite{heer2010crowdsourcing}.
...
\caption{The errors for different questions. The results in parentheses are with outliers removed (sigma clipping with $4 \times sigma$).}
\label{table_errors}
\centering
