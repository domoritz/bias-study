...
\begin{abstract}
\todo{Dom: The abstract goes here.}
\end{abstract}
...
Table \tabref{table_bias} summarizes participant responses.
For question type 1, both the true and expected biases are relatively small (e.g., about 10\% of the correct values).
For question type 2, the true biases averaged over 100\% of the correct values, with an even larger standard deviation.
...
\subsection{Threats to Validity} %I would opt to put this under the experimental setup, but I understand that Mike might want differently.
