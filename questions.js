...
function addPreciseQuestions() {
	...
	$('.form1').append('<h2>Questions about ' + plural(presentationOrder[0]) + '</h2>')
	$('.form2').append('<h2>Questions about ' + plural(presentationOrder[1]) + '</h2>')

	addQuestion('.form1', presentationOrder[0], 'DidYouNotice', 'yesno', 'Was there a difference between the precise and approximate visualization for ' + plural(presentationOrder[0]) + '?');
	...
	addQuestion('.form2', presentationOrder[1], 'DidYouNotice', 'yesno', 'Was there a difference between the precise and approximate visualization for ' + plural(presentationOrder[1]) + '?');
